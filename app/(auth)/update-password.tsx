            ...
            {!success ? (
                ...
                <View style={styles.reqContainer}>
                  <View style={styles.reqRow}>
                    <Ionicons
                      ...
                      size={16}
                      color={password.length >= 6 ? '#000000' : DS.textMuted}
                    />
                  ...
                  <View style={styles.reqRow}>
                    <Ionicons
                      ...
                      size={16}
                      color={password && password === confirmPassword ? '#000000' : DS.textMuted}
                    />
              ...
              <View style={{ alignItems: 'center' }}>
                <View style={styles.iconCircleSuccess}>
                  <Ionicons name="checkmark-circle-outline" size={36} color="#000000" />
                </View>
